...
List<Message> chats = [
  ...
  Message(
    sender: john,
    time: now - 30000,
    text: 'Buddy, you free for a call?, got something to discuss!',
    isLiked: false,
    unread: false,
  ),
  Message(
    sender: sophia,
    time: now - 40000,
    text: 'Heyo! Bet you\'ve never seen this before',
    isLiked: false,
    unread: true,
  ),
  Message(
  ...
  Message(
    sender: greg,
    time: now - 780000000,
    text: 'I\'m at the place you here bruh?',
    isLiked: false,
    unread: false,
  ),
  Message(
